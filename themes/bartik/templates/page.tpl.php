...
<div class="row" style="margin:20px -12px 60px -12px" >
    ...
    <?php endif; ?>
 <!--=============================================
<?php if(!$breadcrumb): ?> koqssq <?php endif;?>
================ -->
<div class="row ">
  <!-- block gauche sup -->
  <?php if(!$breadcrumb): ?> 
    <div class="col-md-2 ">
     ...
     <?php if ($page['sidebar-trois']): ?>
      <div id="sidebar-trois" class="column sidebar"><div class="section">
        <?php print render($page['sidebar-trois']); ?>
...
<div class="row ">
  <!-- block gauche sup -->
    ...
    <!-- block milieu sup -->
      ...
      <?php endif; ?>
 <?php if (!$breadcrumb):?>    <div class="col-md-12 " style="margin:20px -12px 60px -12px"><mark class="mark">Actu </mark>
<div class="bord2"><br> 
<?php endif ; ?>

<?php print render($page['content']); ?>
 <?php if (!$breadcrumb):?>  </div>
      </div>
<?php endif;?> 
 ...
 <div id="content" class="column">
    ...
    <footer>
       <div class="footer">
        ...
        <p style="text-align: center;"> &copy ifreetech 2015 all right reserved</p>
